            ...
            <div className="card-body">
              <Row>
                <div className="col-sm-3 col-12 ps-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="75%" height="" fill="currentColor" className="ms-2 bi bi-person-lines-fill" viewBox="0 0 16 16">
                ...
                <div className="d-flex justify-content-end mb-3 m-3 ">
                  ...
                  <a type="btn" href="profile-edit" className=" me-4 btn-sm btn-primary">Edit</a>
                </div>
              </Row>
            </div>
          </Card>
